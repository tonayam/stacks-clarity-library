    ...
    return (
        <main className='introduction'>
            <section className="watch">
                <h1>How Does Stacks Watch <span>Bitcoin</span>?</h1>
                <img src={headerImg} alt="header" />
            </section>

            <article className='p-o-x'>
                <p className='smart-contracts'><strong>Smart Contracts of the Stacks blockchain</strong> have a view on the Bitcoin Blockchain: In the contracts,
                    the block header hash of any bitcoin block can be requested. This is thanks to the <span>Proof-of-Transfer
                        consensus.</span></p>
                <div className="img">
            ...
            <article className='clarity-bitcoin-library'>
                <p>The <span>Clarity Bitcoin Library</span> is a <strong>Clarity contract</strong> that allows developers to handle information from
